...
<body>
    ...
    <div class="left-sidebar">
        ...
        <hr>
        <label><a href="myfarm.php" class="active"><h4>My Farm</h4></a></label>
        <hr>
    ...
    <!-- CONTENT -->
    <div class="content">
        <h3 style="display:inline-block">My Farm</h3>
        <button style="margin-top: 20px;">New Farm</button>
        <hr>
        
        <!-- <p>It seems that you don't have a farm yet. Create a new farm and publish it to have funding</p> -->
        <div>
            <input type="search" name="search" placeholder="Search" style="width:42%"/>
        ...
        <div class="thumbnails" style="width:30%; height:auto; border: solid grey 1px; padding: 10px; border-radius: 7px; text-align: center; font-size: 12px; overflow:hidden; float:left; margin-right: 20px;">
            ...
            <button style="background-color:grey" disabled>Claim Funds</button>
            <button style="background-color:red;">Cancel</button>
        </div>
