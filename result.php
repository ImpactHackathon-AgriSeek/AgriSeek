...
<div style="width:800px;height:570px;top:10px;left:20px;overflow:auto;padding:15px;position:relative;">
	<div style="width: 100%; display: block">
			<div class="card" style="width:330px; display: block; float: right">
			  <img class="card-img-top" src="./images/fishfarming.jpg" alt="Card image cap">
			  <div class="card-body">
				  <ul class="list-group list-group-flush">
				    <li class="list-group-item"><i class="fas fa-map-marker-alt" id="icon"></i>Governor Generoso, Davao Oriental</li>
			...
			<div class="card" style="width:330px;position:relative;left:30px;">
			  ...
			  <div class="card-body">
				  <ul class="list-group list-group-flush">
				    <li class="list-group-item"><i class="fas fa-map-marker-alt" id="icon"></i>Tagum City, Davao del Norte</li>
				    <li class="list-group-item"><i class="fas fa-user" id="icon"></i>***** ***** *******</li>
				    <li class="list-group-item"><i class="fas fa-info" id="icon"></i>For sale
			...
			<div class="card" style="width:330px;position:relative;left:30px;">
			  ...
			  <div class="card-body">
				  <ul class="list-group list-group-flush">
				    <li class="list-group-item"><i class="fas fa-map-marker-alt" id="icon"></i>Digos City, Davao del Sur</li>
				    <li class="list-group-item"><i class="fas fa-user" id="icon"></i>***** ***** *******</li>
				    <li class="list-group-item"><i class="fas fa-info" id="icon"></i>For Lease
				    	<input type="button" name="discover2" value="Discover" class="btn" style="width:100px;background-color:#24a787;color:white;position:absolute;left:200px;">
				    </li>
				  </ul>
			  </div>
			...
			<br>
			<div class="card" style="width:330px;position:relative;left:30px;">
			  <img class="card-img-top" src="./images/poultry.jpg" alt="Card image cap">
			  <div class="card-body">
				  <ul class="list-group list-group-flush">
...
<form action='result.php' method="post">
	<div style="width:400px;height:400px;left:900px;top:80px;position:absolute;background-color:#f6f7f9;" class="card" id="adjust">
		...
		<br>
		<br>
		<input type="text" name="address" placeholder="Seek Agri Area" class="form-control" style="width:300px;">
		<br>
